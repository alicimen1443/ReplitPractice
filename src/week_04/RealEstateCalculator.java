...
public class RealEstateCalculator {
    ...
    public static void main(String[] args) {
        ...
        boolean isValid=houseType.equals("Condo")||houseType.equals("Townhouse")||houseType.equals("Single Family Home");

        if(isValid){
            switch (houseType){
                case "Condo":
                    propertyPrice+=50000;break;
                case "Townhouse":
                    propertyPrice+=75000;break;
                case "Single Family Home":
                    propertyPrice+=95000;break;
                default: propertyPrice+=0;
            }
            ...
            System.out.println("Not a valid property type");
        }
