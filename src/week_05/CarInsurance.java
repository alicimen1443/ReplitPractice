...
public class CarInsurance {
    public static void main(String[] args) {
        ...
        name=scan.next();
        System.out.println("Do you have a US driver license?(yes or no)");
        driverLicence=scan.next();
        ...
        if(!driverLicence.equalsIgnoreCase("yes")){
            ...
            System.exit(0);
                ...
                switch (vehicleOwnership.toLowerCase()){
                ...
                howManyYears=scan.nextInt();
                if(howManyYears<=0||(age-howManyYears)<16){
                    System.out.println("Invalid data!");
                    System.exit(0);
                }else{
                    premium-=howManyYears*5;
                }
